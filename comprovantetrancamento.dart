...
class PdfCreationPage2 extends StatelessWidget {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 20),
              pw.Text(
                  'Trancamento do Curso: Desenvolvimento de Software Multiplataforma'),
            ],
          );
        },
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Formulário para Trancamento'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Confirmar Trancamento'),
            ),
          ],
        ),
      ),
